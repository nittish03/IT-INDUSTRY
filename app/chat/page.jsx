...
const mentors = [
  {
    id: "mentor1",
    name: "Vrinda",
    linkedin: "https://www.linkedin.com/in/vrinda-bindal-55b645349/",
    Designation: "Software Engineer",
  },
  {
    id: "mentor2",
    name: "Pulkit",
    linkedin: "https://www.linkedin.com/in/pulkit-arora-92502321a/",
    Designation: "Reserach Intern",
  },
  {
    id: "mentor3",
    name: "Karitkey",
...
export default function VideoCall() {
  ...
  return (
    <div className="min-h-screen bg-black mt-18 text-white flex flex-col items-center justify-center p-8">
      <h1 className="text-3xl font-bold mb-4"> Mentor-User Chat</h1>
      <h3 className="text-lg mb-2">
        Your Peer ID: <b className="text-blue-400">{peerId}</b>
      </h3>
      ...
      <ul className="flex flex-wrap justify-center gap-4 mt-4">
        {mentors.map((mentor) => (
          <li
            key={mentor.id}
            className="p-4 border border-gray-600 rounded-lg w-64 text-center"
          >
