...
const Header = ({ user }) => {
  return (
    <>
      <header className="fixed flex justify-between items-center top-0 w-full border-b bg-background/80 backdrop-blur-md z-50 supports-[backdrop-filter]:bg-background/60">
        <Link href="/">
          <h1 className="font-bold text-3xl gradient-text px-2">WorkWise</h1>
        </Link>
        <nav className="mr-5 h-16 flex items-center justify center">
          <div className="flex justify-center items-center">
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              <SignedIn>
                <a
                  target="_blank"
                  href="https://ai-course-generator-gamma-snowy.vercel.app/dashboard"
                >
                  <Button
                    variant="outline"
